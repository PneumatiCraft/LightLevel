...
public class HelpCommand extends LightLevelCommand {
    private static final int CMDS_PER_PAGE = 7;

    public HelpCommand(LightLevel plugin) {
        super(plugin);
        this.setName("Get Help with LightLevel");
        this.setCommandUsage("/llh " + ChatColor.GOLD + "[FILTER] [PAGE #]");
        this.setArgRange(0, 2);
        this.addKey("llh");
        this.addKey("llhelp");
        this.addKey("ll help");
        this.addKey("lightlevel help");
        this.addKey("llsearch");
        this.addKey("ll search");
        this.setPermission("lightlevel.help", "Displays a nice help menu.", PermissionDefault.TRUE);
    }

    @Override
    public void runCommand(CommandSender sender, List<String> args) {
        sender.sendMessage(ChatColor.AQUA + "====[ LightLevel Help ]====");
